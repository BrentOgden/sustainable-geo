...
export default function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-0 md:right-3/12 md:left-3/12 bg-black bg-opacity-90 text-white w-auto h-auto">
      <div className="max-w-6xl mx-auto px-4 py-4 md:flex md:items-center md:justify-between">
        ...
        <button
          ...
          className="mt-4 md:mt-0 bg-white hover:bg-[rgb(13,41,33)] hover:text-black text-black px-6 py-2 rounded"
        >
          Accept
        </button>
      </div>
